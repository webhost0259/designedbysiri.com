...
const CategoryProductCard = () => {
    return (
        ...
        // <div className="flex flex-row justify-between w-full space-x-4 text-black ">
            
        //     <div className="basis-1/2 flex flex-col rounded-md">
        //         <div className="relative w-full h-[184px] bg-gray-200">
        //             <Image 
        //             src="/category-icons/boy-icon.jpeg" 
        //             alt="Surfboard" 
        //             className="rounded-lg object-contain w-full h-full"
        //             layout="fill" 
        //             />
