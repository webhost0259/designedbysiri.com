...
const ProductDetails = ({ product } : ProductDetailsProps) => {
  ...
  return(
      <div className="flex flex-col w-full justify-center items-center px-2 laptop:flex-row  text-black laptop:space-x-16">
        <div className="relative rounded-lg w-full h-96 tablet:w-96 laptop:w-96 laptop:h-[512px] border-2 border-gray-400 laptop:p-4">
          <ImageCarousel imagePaths={product.imagePaths} />
          {/* <Image 
        ...
        <div className="flex flex-col space-y-4 w-full px-4 laptop:max-w-[512px]">
          ...
          <h6 className="font-medium text-xl text-gray-700">{product.productName}</h6>
          ...
          <div className="flex flex-row space-x-4 w-full">
            <Button 
              className="bg-green-600 text-white font-semibold justify-center items-center rounded-lg min-w-36 h-12 laptop:min-w-48 p-4"
